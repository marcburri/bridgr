...
This outlines how to propose a change to bridgr. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("marcburri/bridgr", fork = TRUE)`.
...
of Conduct](https://marcburri.github.io/bridgr/CODE_OF_CONDUCT.md). By
