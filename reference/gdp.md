...
- `baro`:
  ...
  - Source: [KOF Swiss Economic
    Institute](https://datenservice.kof.ethz.ch/)
...
- `fcurve`:
  ...
  - Source: [Burri and Kaufmann
    GitHub](https://github.com/dankaufmann/f-curve)
  ...
  - Format: A tibble with daily observations and 2 variables:
    ...
    - `values`: Numeric, the value of the F-curve (inverted for
      compatibility).
