...
we can see how the different aggregation schemes react.
...
regressors. This corresponds to a U-MIDAS style specification when the
frequency gap is small enough to estimate those coefficients reliably.
